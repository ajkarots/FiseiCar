...
<header class="hero2">
    <nav class="nav container">
        <div class="nav_logo">
            ...
            <h3 class="nav_title">Nuevo vehiculo</h3>
        </div>
    </nav>
</header>
...
<body>
    <main class="main_agregar_vehiculo">
        <section class="agregar">
            <form class="form_agregar_vehiculo" action="./funciones/agregar_vehiculo_sql.php" method="POST" id="formulario_agregar">
                <br></br>
                <h2>agregar</h2>
                ...
                <input class="cuadro_editar" type="text" placeholder="descripcion" id="descripcion_editar" name="descripcion_editar">
                <input class="cuadro_editar" type="file" placeholder="ruta imagen" id="img_editar" name="img_editar" accept="image/*">
                <input class="cuadro_editar" type="number" placeholder="caballos" id="caballos_editar" name="caballos_editar" min="0">
                <input class="cuadro_editar" type="number" placeholder="precio" id="precio_editar" name="precio_editar" min="0">
                ...
                <button type="submit" class="btn_sql" id="btn_guardar">Agregar</button>
    ...
    <script>
        ...
        document.getElementById('formulario_agregar').addEventListener('submit', function(event) {
