...
<body>
    <main>
        <section class="editar">
            ...
            <form class="form_editar" action="./funciones/nuevo_usuario.php" method="POST" id="formulario_editar_perfil">
                <br>
                <h2>Editar</h2>
                <br>
                <h5>Nombre</h5>
                ...
                <h5>Edad</h5>
                <input class="cuadro_editar" type="text" min="18" id="edad_usuario" name="edad_usuario" placeholder="Edad">
                <h5>Provincia</h5>
                ...
                <h5>Telefono</h5>
                <input class="cuadro_editar" type="text" minlength="10" id="telefono_usuario" name="telefono_usuario" placeholder="Telefono">
